...
#'
#' The very much unofficial package with tools to create plots in `ggplot` using 
#' the NORMENT house style and other functionality tools useful for R-users at 
#' NORMENT.
#'
